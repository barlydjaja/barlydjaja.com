...
const About = () => {
  return (
    <section className='px-8 flex flex-wrap-reverse gap-20 sm:gap-0 mb-20'>
      {/*LEFT SECTION*/}
      <section className='flex-1 h-72 m-4 relative'>
        <span className='absolute -top-4 -left-4 w-24 h-24 border-white border rounded-2xl'/>

        <Image fill src={FrontendImg} alt='profile-picture' sizes='84rem,80rem' className='rounded-2xl object-cover border-gradient2 max-w-sm' />
      </section>
